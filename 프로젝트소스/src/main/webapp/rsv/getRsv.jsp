    ...
    <div id="cntnr">
        ...
        <form action="updatersv.do" method="post">
            <input name="rsv_id" type="hidden" value="${rsv.rsv_id}" />
             <input name="parking_id" type="hidden" value="${rsv.parking.parking_id}" />
            <table id="rsv_info" border="0" cellpadding="10" cellspacing="10">
                ...
                <tr>
                    <!-- <td>시간</td> -->
                    <td align="left">${rsv.rsv_outtime}</td>
                </tr>
               
                <tr>
                    <!-- <td>파킹보드 제목</td> -->
                    <td align="left">${rsv.parking.parking_title}</td>
                </tr>
                <tr>
                    <!-- <td>시간당 주차 요금</td> -->
                    <td align="left">${rsv.parking.parking_price}</td>
                </tr>
                <tr>
                    <!-- <td>이용 시간</td> -->
                    <td align="left">이용시간은 JS로 계산해</td>
                </tr>
                <tr>
                    <!-- <td>결제 금액</td> -->
